...
public class SevenZipTests
{
    ...
    public void Test7z()
    {
        ...
        {
            { "subdir/", new ExtractedEntry(EntryType.Directory, 0L, emptyHash) },
            { "empty", new ExtractedEntry(EntryType.RegularFile, 0L, emptyHash) },
            { "subdir/empty", new ExtractedEntry(EntryType.RegularFile, 0L, emptyHash) },
            { "1gzero", new ExtractedEntry(EntryType.RegularFile, 0x40000000L, "49-BC-20-DF-15-E4-12-A6-44-72-42-1E-13-FE-86-FF-1C-51-65-E1-8B-2A-FC-CF-16-0D-4D-C1-9F-E6-8A-14") },
            { "1krandom", new ExtractedEntry(EntryType.RegularFile, 1024L, "DA-26-F3-BE-7A-9A-2D-F1-0A-49-35-87-8B-18-C8-FF-FE-2B-96-13-EA-CD-E2-C8-67-DF-8A-A2-5D-41-0D-0A") },
        }));
    }
    ...
    public void TestMultiRar()
    {
        ...
        Assert.That(extracted, Is.EquivalentTo(new Dictionary<string, ExtractedEntry>
        {
            ...
            { "empty", new ExtractedEntry(EntryType.RegularFile, 0L, emptyHash) },
            { "subdir/empty", new ExtractedEntry(EntryType.RegularFile, 0L, emptyHash) },
            { "1gzero", new ExtractedEntry(EntryType.RegularFile, 0x40000000L, "8B-A9-05-B1-20-A7-C8-D7-89-0F-AB-53-3B-75-65-C9-2C-3D-30-B7-E2-98-41-DF-52-C0-CF-F3-9D-3C-F1-A2") },
            { "1krandom", new ExtractedEntry(EntryType.RegularFile, 1024L, "DA-26-F3-BE-7A-9A-2D-F1-0A-49-35-87-8B-18-C8-FF-FE-2B-96-13-EA-CD-E2-C8-67-DF-8A-A2-5D-41-0D-0A") },
        }));
    }
