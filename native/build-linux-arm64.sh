...
export CC="sccache $TOOLCHAIN_PREFIX/bin/aarch64-linux-gcc"
export CXX="sccache $TOOLCHAIN_PREFIX/bin/aarch64-linux-g++"
export AR=$TOOLCHAIN_PREFIX/bin/aarch64-linux-ar
export RANLIB=$TOOLCHAIN_PREFIX/bin/aarch64-linux-ranlib
