...
./configure --cache-file=$(get_config_cache i686-linux) --build=x86_64-pc-linux-gnu --host=i686-linux --with-pic --disable-shared --prefix=$PREFIX --disable-maintainer-mode
make -sj$NCPU install
cd ..
