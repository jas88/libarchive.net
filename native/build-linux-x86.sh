...
cd lzo-${LZO_VERSION}
./configure --quiet --cache-file=$(get_config_cache i686-linux) --build=x86_64-pc-linux-gnu --host=i686-linux --prefix=$PREFIX --disable-shared --enable-static
...
cd xz-${XZ_VERSION}
./configure --quiet --cache-file=$(get_config_cache i686-linux) --build=x86_64-pc-linux-gnu --host=i686-linux --with-pic --disable-shared --prefix=$PREFIX
make -sj$NCPU install
cd ..
